...
public class MogusEntity extends MonsterEntity
{
    ...
    public ITextComponent getName()
    {
        ...
        {
            String type = this.getMushroomType() == MushroomType.BROWN ? "brown" : this.getMushroomType() == MushroomType.RED ? "red" : "white";
    ...
    {
        return this.getMushroomType().getLootTable();
    }
    ...
    {
        return MushroomType.getFromOrdinal(this.dataManager.get(TYPE));
    }

    private void setRandomMushroomType()
    {
        this.setType(this.rand.nextInt(10) > 1 ? this.rand.nextInt(10) < 5 ? MushroomType.BROWN : MushroomType.RED : MushroomType.WHITE);
    }

    public void setType(MushroomType mushroomType)
    {
        this.dataManager.set(TYPE, mushroomType.ordinal());
    }
    ...
    public enum MushroomType
    {
        ...
        MushroomType(ResourceLocation texture, ResourceLocation lootTable)
        {
        ...
        static MushroomType getFromOrdinal(int ordinal)
        {
