...
public class EntityAIPigtificateMate extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            else if(this.doesVillageHaveRoom() && this.pigtificate.isWillingToMate(true))
            {
                ...
                {
                    this.mate = entity;
                    return this.mate.getGrowingAge() == 0 && this.mate.isWillingToMate(true);
                }
            }
            else
            {
    ...
    {
        return this.matingTimeout >= 0 && this.doesVillageHaveRoom() && this.pigtificate.getGrowingAge() == 0 && this.pigtificate.isWillingToMate(false);
    }
