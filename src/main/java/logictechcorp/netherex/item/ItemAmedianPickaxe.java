...
import logictechcorp.libraryex.item.ItemPickaxeLibEx;
...
public class ItemAmedianPickaxe extends ItemPickaxeLibEx
{
    public ItemAmedianPickaxe()
    {
        super(NetherEx.instance, "amedian_pickaxe", NetherExMaterials.AMEDIAN);
