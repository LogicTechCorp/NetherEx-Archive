...
import logictechcorp.libraryex.item.ItemHammerLibEx;
...
public class ItemAmedianHammer extends ItemHammerLibEx
{
    public ItemAmedianHammer()
    {
        super(NetherEx.instance, "amedian_hammer", NetherExMaterials.AMEDIAN);
