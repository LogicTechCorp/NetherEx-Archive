...
import logictechcorp.libraryex.item.ItemSwordLibEx;
...
public class ItemAmedianSword extends ItemSwordLibEx
{
    public ItemAmedianSword()
    {
        super(NetherEx.instance, "amedian_sword", NetherExMaterials.AMEDIAN);
