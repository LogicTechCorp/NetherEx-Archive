...
import logictechcorp.libraryex.item.ItemHoeLibEx;
...
public class ItemAmedianHoe extends ItemHoeLibEx
{
    public ItemAmedianHoe()
    {
        super(NetherEx.instance, "amedian_hoe", NetherExMaterials.AMEDIAN);
