...
public class HugeRedElderMushroomFeature extends BigRedMushroomFeature
{
    public HugeRedElderMushroomFeature(Function<Dynamic<?>, ? extends BigMushroomFeatureConfig> configFactory)
    {
        super(configFactory);
    }
