...
public class ModelCoolmarSpider extends ModelBase
{
    ...
    public ModelCoolmarSpider()
    {
        ...
        this.neck.setRotationPoint(0.0F, 12.0F, 7.0F);
        this.neck.addBox(-4.0F, -4.0F, -8.0F, 8, 8, 8);
        this.setRotationAngles(this.neck, 0.19634954084936207F, 0.0F, 0.0F);
        this.body = new ModelRenderer(this, 0, 26);
        this.body.setRotationPoint(0.0F, 12.5F, 11.0F);
        this.body.addBox(-6.0F, -5.0F, -6.5F, 12, 10, 13);
        this.setRotationAngles(this.body, -0.2617993877991494F, 0.0F, 0.0F);
