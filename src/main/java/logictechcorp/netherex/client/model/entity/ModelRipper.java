...
public class ModelRipper extends ModelBase
{
    ...
    public ModelRipper()
    {
        ...
        this.fangs.setRotationPoint(0.0F, 4.0F, -7.1F);
        this.fangs.addBox(-3.5F, -2.0F, 0.0F, 7, 4, 0, 0.0F);
        ...
        this.headWrap.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        this.head.addChild(this.headWrap);
