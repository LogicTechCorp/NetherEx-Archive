...
public class SpinoutModel extends EntityModel<SpinoutEntity>
{
    ...
    private RendererModel middleBody;
    private RendererModel lowerBody;
    private RendererModel upperSpinner;
    private RendererModel middleSpinner;
    private RendererModel lowerSpinner;
    ...
    @Override
    public void setRotationAngles(SpinoutEntity spinout, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
