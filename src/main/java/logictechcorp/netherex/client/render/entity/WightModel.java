...
public class WightModel extends EntityModel<WightEntity>
{
    ...
    public WightModel()
    {
        ...
        this.hood = new RendererModel(this, 0, 0);
        this.hood.addBox(-2.5F, -2.5F, -2.5F, 5, 5, 5, 0F);
        this.hood.setRotationPoint(0F, 2.5F, -3.5F);
        this.upperBody = new RendererModel(this, 14, 23);
        ...
        this.lowerBody = new RendererModel(this, 0, 24);
        this.lowerBody.addBox(-2.5F, -3.0F, -1F, 5, 6, 2, 0F);
        this.lowerBody.setRotationPoint(0F, 10.5F, 0F);
        this.rightArm = new RendererModel(this, 24, 0);
        this.rightArm.addBox(-0.5F, -0.5F, -0.5F, 1, 18, 1, 0F);
        this.rightArm.setRotationPoint(-3.5F, 5F, 0F);
        this.leftArm = new RendererModel(this, 24, 0);
        this.leftArm.addBox(-0.5F, -0.5F, -0.5F, 1, 18, 1, 0F);
        this.leftArm.setRotationPoint(3.5F, 5F, 0F);
        this.rightLeg = new RendererModel(this, 20, 0);
        this.rightLeg.addBox(-0.5F, -0.5F, -0.5F, 1, 12, 1, 0F);
        this.rightLeg.setRotationPoint(1, 13, 0);
        this.leftLeg = new RendererModel(this, 20, 0);
        this.leftLeg.addBox(-0.5F, -0.5F, -0.5F, 1, 12, 1, 0F);
        this.leftLeg.setRotationPoint(-1, 13, 0);
    }

    @Override
    public void render(WightEntity wight, float limbSwing, float limbSwingAmount, float ageInTicks, float rotationYaw, float rotationPitch, float scaleFactor)
    {
        this.setRotationAngles(wight, limbSwing, limbSwingAmount, ageInTicks, rotationYaw, rotationPitch, scaleFactor);
    ...
    @Override
    public void setRotationAngles(WightEntity wight, float limbSwing, float limbSwingAmount, float ageInTicks, float rotationYaw, float rotationPitch, float scaleFactor)
    {
