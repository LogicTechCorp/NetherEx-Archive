...
public class NetherExTextures
{
    ...
    public static final ResourceLocation PIGTIFICATE_CHIEF_ALT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_chief_alt.png");
    ...
    public static final ResourceLocation PIGTIFICATE_HUNTER_ALT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_hunter_alt.png");
    public static final ResourceLocation PIGTIFICATE_GATHERER = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_gatherer.png");
    public static final ResourceLocation PIGTIFICATE_GATHERER_ALT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_gatherer_alt.png");
    public static final ResourceLocation PIGTIFICATE_SCAVENGER = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_scavenger.png");
    public static final ResourceLocation PIGTIFICATE_SCAVENGER_ALT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_scavenger_alt.png");
    public static final ResourceLocation PIGTIFICATE_ARMORSMITH = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_armorsmith.png");
    public static final ResourceLocation PIGTIFICATE_ARMORSMITH_ALT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_armorsmith_alt.png");
    ...
    public static final ResourceLocation PIGTIFICATE_TOOLSMITH_ALT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_toolsmith_alt.png");
    ...
    public static final ResourceLocation PIGTIFICATE_ENCHANTER_ALT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_enchanter_alt.png");
    ...
    public static final ResourceLocation PIGTIFICATE_BREWER_ALT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/pigtificate/pigtificate_brewer_alt.png");
    ...
    public static final ResourceLocation MOGUS_WHITE = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/mogus/white_mogus.png");
    public static final ResourceLocation ORANGE_SALAMANDER = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/salamander/orange_salamander.png");
    public static final ResourceLocation BLACK_SALAMANDER = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/salamander/black_salamander.png");
    public static final ResourceLocation WIGHT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/wight.png");
    public static final ResourceLocation EMBER = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/ember.png");
    public static final ResourceLocation NETHERMITE = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/nethermite.png");
    public static final ResourceLocation SPINOUT = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/spinout.png");
    public static final ResourceLocation SPORE_CREEPER = new ResourceLocation(NetherEx.MOD_ID + ":textures/entities/spore_creeper.png");
