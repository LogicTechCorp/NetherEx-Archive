    ...
    public static class EventHandler
    {
        ...
        public static void onRegisterItems(RegistryEvent.Register<Item> event)
        {
            event.getRegistry().registerAll(
                    ...
                    new ItemModAxe(NetherEx.getResource("withered_amedian_axe"), (ItemToolProperties) new ItemToolProperties(NetherExMaterials.AMEDIAN, 9.0F, -2.8F).creativeTab(NetherEx.instance.getCreativeTab())),
                    ...
                    new ItemModAxe(NetherEx.getResource("blazed_amedian_axe"), (ItemToolProperties) new ItemToolProperties(NetherExMaterials.AMEDIAN, 9.0F, -2.8F).creativeTab(NetherEx.instance.getCreativeTab())),
                    ...
                    new ItemModAxe(NetherEx.getResource("frosted_amedian_axe"), (ItemToolProperties) new ItemToolProperties(NetherExMaterials.AMEDIAN, 9.0F, -2.8F).creativeTab(NetherEx.instance.getCreativeTab())),
                    ...
                    new ItemModArmor(NetherEx.getResource("orange_salamander_hide_helmet"), (ItemArmorProperties) new ItemArmorProperties(NetherExMaterials.ORANGE_SALAMANDER_HIDE, EntityEquipmentSlot.HEAD).creativeTab(NetherEx.instance.getCreativeTab())),
                    new ItemModArmor(NetherEx.getResource("orange_salamander_hide_chestplate"), (ItemArmorProperties) new ItemArmorProperties(NetherExMaterials.ORANGE_SALAMANDER_HIDE, EntityEquipmentSlot.CHEST).creativeTab(NetherEx.instance.getCreativeTab())),
                    new ItemModArmor(NetherEx.getResource("orange_salamander_hide_leggings"), (ItemArmorProperties) new ItemArmorProperties(NetherExMaterials.ORANGE_SALAMANDER_HIDE, EntityEquipmentSlot.LEGS).creativeTab(NetherEx.instance.getCreativeTab())),
                    new ItemModArmor(NetherEx.getResource("orange_salamander_hide_boots"), (ItemArmorProperties) new ItemArmorProperties(NetherExMaterials.ORANGE_SALAMANDER_HIDE, EntityEquipmentSlot.FEET).creativeTab(NetherEx.instance.getCreativeTab())),
                    new ItemModArmor(NetherEx.getResource("black_salamander_hide_helmet"), (ItemArmorProperties) new ItemArmorProperties(NetherExMaterials.BLACK_SALAMANDER_HIDE, EntityEquipmentSlot.HEAD).creativeTab(NetherEx.instance.getCreativeTab())),
                    new ItemModArmor(NetherEx.getResource("black_salamander_hide_chestplate"), (ItemArmorProperties) new ItemArmorProperties(NetherExMaterials.BLACK_SALAMANDER_HIDE, EntityEquipmentSlot.CHEST).creativeTab(NetherEx.instance.getCreativeTab())),
                    new ItemModArmor(NetherEx.getResource("black_salamander_hide_leggings"), (ItemArmorProperties) new ItemArmorProperties(NetherExMaterials.BLACK_SALAMANDER_HIDE, EntityEquipmentSlot.LEGS).creativeTab(NetherEx.instance.getCreativeTab())),
                    new ItemModArmor(NetherEx.getResource("black_salamander_hide_boots"), (ItemArmorProperties) new ItemArmorProperties(NetherExMaterials.BLACK_SALAMANDER_HIDE, EntityEquipmentSlot.FEET).creativeTab(NetherEx.instance.getCreativeTab()))
            );
        }
    }
