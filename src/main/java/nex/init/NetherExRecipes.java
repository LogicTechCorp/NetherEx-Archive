...
public class NetherExRecipes
{
    ...
    public static void init()
    {
        ...
        removeRecipe(Item.getItemFromBlock(Blocks.NETHER_BRICK_FENCE));
        removeRecipe(Item.getItemFromBlock(Blocks.BONE_BLOCK));
        ...
        add3x3Recipe(new ItemStack(NetherExBlocks.BLOCK_BONE, 1, 0), new ItemStack(Items.DYE, 9, EnumDyeColor.WHITE.getDyeDamage()));
        add2x3Recipe(new ItemStack(NetherExBlocks.BLOCK_BONE, 1, 1), new ItemStack(Items.DYE, 9, EnumDyeColor.WHITE.getDyeDamage()));
        add1x3Recipe(new ItemStack(NetherExBlocks.BLOCK_BONE, 1, 2), new ItemStack(Items.DYE, 9, EnumDyeColor.WHITE.getDyeDamage()));
        ...
        addStairRecipe(new ItemStack(STAIRS_RED_BRICK_NETHER, 8, 0), new ItemStack(Blocks.RED_NETHER_BRICK, 3, 0));
        ...
        addFenceRecipe(new ItemStack(Blocks.NETHER_BRICK_FENCE, 4, 0), new ItemStack(FENCE_GATE_BRICK_NETHER, 4, 0), new ItemStack(Blocks.NETHER_BRICK, 1, 0), new ItemStack(Blocks.STONE_SLAB, 1, 6));
        addFenceRecipe(new ItemStack(FENCE_VANILLA, 4, 1), new ItemStack(FENCE_GATE_RED_BRICK_NETHER, 4, 0), new ItemStack(Blocks.RED_NETHER_BRICK, 1, 0), new ItemStack(SLAB_VANILLA, 1, 0));
        ...
        addShapeless(new ItemStack(Items.DYE, 9, EnumDyeColor.WHITE.getDyeDamage()), new ItemStack(NetherExBlocks.BLOCK_BONE, 1, 0));
        addShapeless(new ItemStack(Items.DYE, 6, EnumDyeColor.WHITE.getDyeDamage()), new ItemStack(NetherExBlocks.BLOCK_BONE, 1, 1));
        addShapeless(new ItemStack(Items.DYE, 3, EnumDyeColor.WHITE.getDyeDamage()), new ItemStack(NetherExBlocks.BLOCK_BONE, 1, 2));
        ...
        addSwordRecipe(new ItemStack(TOOL_SWORD_BONE, 1, 0), new ItemStack(Items.GOLD_INGOT, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addPickaxeRecipe(new ItemStack(TOOL_PICKAXE_BONE, 1, 0), new ItemStack(Items.GOLD_INGOT, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addShovelRecipe(new ItemStack(TOOL_SHOVEL_BONE, 1, 0), new ItemStack(Items.GOLD_INGOT, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addAxeRecipe(new ItemStack(TOOL_AXE_BONE, 1, 0), new ItemStack(Items.GOLD_INGOT, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addHoeRecipe(new ItemStack(TOOL_HOE_BONE, 1, 0), new ItemStack(Items.GOLD_INGOT, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addShovelRecipe(new ItemStack(TOOL_SWORD_BONE, 1, 0), new ItemStack(Items.GOLDEN_SWORD, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addShovelRecipe(new ItemStack(TOOL_PICKAXE_BONE, 1, 0), new ItemStack(Items.GOLDEN_PICKAXE, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addShovelRecipe(new ItemStack(TOOL_SHOVEL_BONE, 1, 0), new ItemStack(Items.GOLDEN_SHOVEL, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addShovelRecipe(new ItemStack(TOOL_AXE_BONE, 1, 0), new ItemStack(Items.GOLDEN_AXE, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
        addShovelRecipe(new ItemStack(TOOL_HOE_BONE, 1, 0), new ItemStack(Items.GOLDEN_HOE, 1, 0), new ItemStack(ITEM_BONE_WITHER, 1, 0));
