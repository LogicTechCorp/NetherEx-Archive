...
{
    private static final ResourceLocation ORANGE_SALAMANDER_TEXTURE = new ResourceLocation(NetherEx.MOD_ID, "textures/entity/salamander_orange.png");
    private static final ResourceLocation BLACK_SALAMANDER_TEXTURE = new ResourceLocation(NetherEx.MOD_ID, "textures/entity/salamander_black.png");
