...
public class BiomeHell extends NetherBiomeBase
{
    public BiomeHell(int id, String name, int weight, BiomeProperties properties)
    {
        ...
        biomeFeatures.add(new BiomeFeatureFire(2, 4, 120));
        ...
        biomeFeatures.add(new BiomeFeatureBush(2, 4, 120, Blocks.RED_MUSHROOM.getDefaultState(), Blocks.NETHERRACK.getDefaultState()));
        biomeFeatures.add(new BiomeFeatureBush(2, 4, 120, Blocks.BROWN_MUSHROOM.getDefaultState(), Blocks.NETHERRACK.getDefaultState()));
    }
}
