...
public class WorldGenBlazingPyramid extends WorldGenerator
{
    ...
    public boolean generate(World world, Random rand, BlockPos pos)
    {
        ...
        BlockPos spawnPos = WorldGenUtil.getSuitableHeight(world, Template.getZeroPositionWithTransform(new BlockPos(chunkPos.getXStart() + 8 - structureSize.getX() / 2, 96, chunkPos.getZStart() + 8 - structureSize.getZ() / 2), mirror, rotation, structureSize.getX(), structureSize.getZ()), structureSize.getX(), structureSize.getZ(), 0.8F);
