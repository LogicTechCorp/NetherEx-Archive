...
public abstract class StructureComponentNetherEx extends StructureComponent
{
    ...
    protected StructureComponentNetherEx()
    {

    }

    public StructureComponentNetherEx(int componentType)
    {
        super(componentType);
    }
