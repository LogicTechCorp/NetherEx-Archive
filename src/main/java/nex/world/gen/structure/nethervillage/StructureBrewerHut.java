...
public class StructureBrewerHut extends StructureNetherVillage
{
    ...
    static
    {
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_brewer"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_brewer_variant"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_brewer_variant_2"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_brewer_variant_3"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_brewer_variant_4"), new BlockPos(9, 5, 9));
    }

    public StructureBrewerHut()
    {
    }

    private StructureBrewerHut(StructureNetherVillageWell.Controller controller, int componentType, ResourceLocation structureIn, BlockPos structureSizeIn, Random rand, StructureBoundingBox boundingBoxIn, EnumFacing facing)
    {
    ...
    public static StructureBrewerHut createComponent(StructureNetherVillageWell.Controller controller, List<StructureComponent> components, Random rand, int minX, int minY, int minZ, EnumFacing facing, int componentType)
    {
        ...
        return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(components, boundingBox) == null ? new StructureBrewerHut(controller, componentType, structure, structureSize, rand, boundingBox, facing) : null;
    }
