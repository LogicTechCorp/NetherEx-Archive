...
public class StructureHunterHut extends StructureNetherVillage
{
    ...
    static
    {
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_hunter"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_hunter_variant"), new BlockPos(9, 5, 9));
    }

    public StructureHunterHut()
    {
    }

    private StructureHunterHut(StructureNetherVillageWell.Controller controller, int componentType, ResourceLocation structureIn, BlockPos structureSizeIn, Random rand, StructureBoundingBox boundingBoxIn, EnumFacing facing)
    {
    ...
    public static StructureHunterHut createComponent(StructureNetherVillageWell.Controller controller, List<StructureComponent> components, Random rand, int minX, int minY, int minZ, EnumFacing facing, int componentType)
    {
        ...
        return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(components, boundingBox) == null ? new StructureHunterHut(controller, componentType, structure, structureSize, rand, boundingBox, facing) : null;
    }
