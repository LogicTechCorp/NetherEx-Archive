...
public class StructureToolsmithHut extends StructureNetherVillage
{
    ...
    static
    {
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_toolsmith"), new BlockPos(9, 5, 8));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_toolsmith_variant"), new BlockPos(12, 5, 8));
    }

    public StructureToolsmithHut()
    {
    }

    private StructureToolsmithHut(StructureNetherVillageWell.Controller controller, int componentType, ResourceLocation structureIn, BlockPos structureSizeIn, Random rand, StructureBoundingBox boundingBoxIn, EnumFacing facing)
    {
    ...
    public static StructureToolsmithHut createComponent(StructureNetherVillageWell.Controller controller, List<StructureComponent> components, Random rand, int minX, int minY, int minZ, EnumFacing facing, int componentType)
    {
        ...
        return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(components, boundingBox) == null ? new StructureToolsmithHut(controller, componentType, structure, structureSize, rand, boundingBox, facing) : null;
    }
