...
public class StructureNetherVillageSmallFarm extends StructureNetherVillage
{
    private Block cropA;
    private Block cropB;

    public StructureNetherVillageSmallFarm()
    {
    }

    private StructureNetherVillageSmallFarm(StructureNetherVillageWell.Controller controller, int componentType, Random rand, StructureBoundingBox boundingBoxIn, EnumFacing facing)
    {
    ...
    public static StructureNetherVillageSmallFarm createPiece(StructureNetherVillageWell.Controller controller, List<StructureComponent> components, Random rand, int minX, int minY, int minZ, EnumFacing facing, int componentType)
    {
        StructureBoundingBox boundingBox = StructureBoundingBox.getComponentToAddBoundingBox(minX, minY, minZ, 0, 0, 0, 7, 4, 9, facing);
        return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(components, boundingBox) == null ? new StructureNetherVillageSmallFarm(controller, componentType, rand, boundingBox, facing) : null;
    }
    ...
    public boolean addComponentParts(World world, Random rand, StructureBoundingBox boundingBoxIn)
    {
        ...
        fillWithBlocks(world, boundingBoxIn, 0, 1, 0, 6, 4, 8, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
        ...
        fillWithBlocks(world, boundingBoxIn, 1, 0, 0, 5, 0, 0, iblockstate, iblockstate, false);
        fillWithBlocks(world, boundingBoxIn, 1, 0, 8, 5, 0, 8, iblockstate, iblockstate, false);
        ...
        for(int j1 = 0; j1 < 9; ++j1)
        {
            ...
            {
                clearCurrentPositionBlocksUpwards(world, k1, 4, j1, boundingBoxIn);
                replaceAirAndLiquidDownwards(world, Blocks.NETHERRACK.getDefaultState(), k1, -1, j1, boundingBoxIn);
            }
        }
