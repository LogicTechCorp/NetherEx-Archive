...
public class StructureGathererHut extends StructureNetherVillage
{
    ...
    static
    {
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_gatherer"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_gatherer_variant"), new BlockPos(9, 5, 9));
    }

    public StructureGathererHut()
    {
    }

    private StructureGathererHut(StructureNetherVillageWell.Controller controller, int componentType, ResourceLocation structureIn, BlockPos structureSizeIn, Random rand, StructureBoundingBox boundingBoxIn, EnumFacing facing)
    {
    ...
    public static StructureGathererHut createComponent(StructureNetherVillageWell.Controller controller, List<StructureComponent> components, Random rand, int minX, int minY, int minZ, EnumFacing facing, int componentType)
    {
        ...
        return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(components, boundingBox) == null ? new StructureGathererHut(controller, componentType, structure, structureSize, rand, boundingBox, facing) : null;
    }
