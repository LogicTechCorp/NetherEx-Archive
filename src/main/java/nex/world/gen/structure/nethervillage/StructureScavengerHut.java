...
public class StructureScavengerHut extends StructureNetherVillage
{
    ...
    static
    {
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_scavenger"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_scavenger_variant"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_scavenger_variant_2"), new BlockPos(9, 5, 9));
        STRUCTURES.put(new ResourceLocation(NetherEx.MOD_ID + ":village_nether_hell_hut_scavenger_variant_3"), new BlockPos(9, 5, 9));
    }

    public StructureScavengerHut()
    {
    }

    private StructureScavengerHut(StructureNetherVillageWell.Controller controller, int componentType, ResourceLocation structureIn, BlockPos structureSizeIn, Random rand, StructureBoundingBox boundingBoxIn, EnumFacing facing)
    {
    ...
    public static StructureScavengerHut createComponent(StructureNetherVillageWell.Controller controller, List<StructureComponent> components, Random rand, int minX, int minY, int minZ, EnumFacing facing, int componentType)
    {
        ...
        return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(components, boundingBox) == null ? new StructureScavengerHut(controller, componentType, structure, structureSize, rand, boundingBox, facing) : null;
    }
