...
public class WorldGenCeilingStructure extends WorldGenerator
{
    ...
    public WorldGenCeilingStructure(String biomeName, String structureName, String[] variantsIn, String[] spawnerMobsIn, ResourceLocation[] lootTablesIn)
    {
