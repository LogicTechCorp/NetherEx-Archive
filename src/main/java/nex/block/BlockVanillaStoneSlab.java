...
public class BlockVanillaStoneSlab extends BlockNetherExSlab
{
    ...
    {
        super("vanilla_stone_slab", Material.ROCK, isDoubleIn);
    ...
    {
        return Item.getItemFromBlock(NetherExBlocks.VANILLA_STONE_SLAB);
    }
    ...
    {
        return new ItemStack(NetherExBlocks.VANILLA_STONE_SLAB, 1, damageDropped(state));
    }
