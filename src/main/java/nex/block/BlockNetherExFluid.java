/*
 * Copyright (C) 2017.  LogicTechCorp
 *
...
public class BlockNetherExFluid extends BlockFluidClassic
{
    public BlockNetherExFluid(String name, Fluid fluid, Material material)
    {
