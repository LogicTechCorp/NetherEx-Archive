...
public class BlockEnokiStem extends BlockNetherEx
{
    ...
    {
        super("plant_enoki_stem", Material.PLANTS);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos)
    {
        ...
        return state.withProperty(DOWN, block == this || block == NetherExBlocks.PLANT_ENOKI_CAP)
                .withProperty(UP, block1 == this || block1 == Blocks.NETHERRACK || block1 == NetherExBlocks.BLOCK_NETHERRACK || block1 == NetherExBlocks.PLANT_ENOKI_CAP)
                .withProperty(NORTH, block2 == this || block2 == NetherExBlocks.PLANT_ENOKI_CAP)
                .withProperty(EAST, block3 == this || block3 == NetherExBlocks.PLANT_ENOKI_CAP)
                .withProperty(SOUTH, block4 == this || block4 == NetherExBlocks.PLANT_ENOKI_CAP)
                .withProperty(WEST, block5 == this || block5 == NetherExBlocks.PLANT_ENOKI_CAP);
    }
    ...
    private boolean canSurviveAt(World wordIn, BlockPos pos)
    {
        ...
        for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            if(block == this)
            {
                ...
                if(state1.getBlock() == this || state1.getBlock() == Blocks.NETHERRACK || state1 == NetherExBlocks.BLOCK_NETHERRACK.getStateFromMeta(2))
                {
                    return true;
                }
            }
        ...
        return state2.getBlock() == this || state2.getBlock() == Blocks.NETHERRACK || state2 == NetherExBlocks.BLOCK_NETHERRACK.getStateFromMeta(2);
    }
}
