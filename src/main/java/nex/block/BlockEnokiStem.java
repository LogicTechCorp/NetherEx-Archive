...
public class BlockEnokiStem extends BlockNetherEx
{
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos)
    {
        ...
        return state.withProperty(DOWN, block == this || block == ModBlocks.ENOKI_CAP).withProperty(UP, block1 == this || block1 == Blocks.NETHERRACK || block1 == ModBlocks.NETHERRACK || block1 == ModBlocks.ENOKI_CAP).withProperty(NORTH, block2 == this || block2 == ModBlocks.ENOKI_CAP).withProperty(EAST, block3 == this || block3 == ModBlocks.ENOKI_CAP).withProperty(SOUTH, block4 == this || block4 == ModBlocks.ENOKI_CAP).withProperty(WEST, block5 == this || block5 == ModBlocks.ENOKI_CAP);
    }
    ...
    private boolean canSurviveAt(World wordIn, BlockPos pos)
    {
        ...
        for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            if(block == this)
            {
                ...
                if(block1 == this || block1 == Blocks.NETHERRACK || block1 == ModBlocks.NETHERRACK)
                {
                    return true;
                }
            }
        ...
        return block2 == this || block2 == Blocks.NETHERRACK || block2 == ModBlocks.NETHERRACK;
    }
}
