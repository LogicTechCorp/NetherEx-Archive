...
public class BlockNetherExWall extends BlockNetherEx
{
    ...
    public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        return block != Blocks.BARRIER && (!(block != this && !(block instanceof BlockFenceGate || block instanceof BlockNetherExFenceGate)) || ((state.getMaterial().isOpaque() && state.isFullCube()) && state.getMaterial() != Material.GOURD));
    }
}
