...
public class ItemBlockNetherrackPath extends ItemBlockLibEx
{
    ...
    {
        return super.getUnlocalizedName() + "." + CaseFormat.LOWER_UNDERSCORE.to(CaseFormat.LOWER_CAMEL, BlockNetherrackPath.EnumType.fromMeta(stack.getItemDamage()).getName());
    }
}
