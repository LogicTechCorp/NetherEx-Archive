...
public class ItemBoneArmor extends ItemNetherExArmor
{
    ...
    {
        return NBTUtil.setTag(armor).getTagCompound().hasKey("Variant") && repair.getItem() == NetherExItems.ITEM_BONE_WITHERED || !NBTUtil.setTag(armor).getTagCompound().hasKey("Variant") && repair.getItem() == Items.BONE;
    }
