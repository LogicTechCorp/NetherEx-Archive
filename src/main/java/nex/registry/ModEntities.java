...
public class ModEntities
{
    public static void register()
    {
        ...
        registerEntityWithEgg(EnumCreatureType.MONSTER, EntityPordenfer.class, "pordenfer", 2, 64, 3, 10, 2, 4, 16711680, 16762880);
        registerEntityWithEgg(EnumCreatureType.AMBIENT, EntityTortoise.class, "tortoise", 3, 64, 3, 10, 2, 4, 16711680, 16762880);
    }
