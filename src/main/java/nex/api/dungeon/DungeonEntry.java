...
public class DungeonEntry extends WeightedRandom.Item
{
    private String name;
    ...
    public DungeonEntry(String name, int weight, IBlockState wallBlockState, IBlockState floorBlockState, DungeonHooks.DungeonMob... dungeonMobs)
    {
        super(weight);
        this.name = name;
